...
<body>
	<h1>
		요금제<input type="text" name="plan_idx" value="1">
	</h1>
	<h1>기업idx</h1>
	<input type="text" name="com_idx" value="7">
	...
	<form action="noticeWrite.do" method="post" id="writeForm">
		...
		<div>
			...
			<table>
				...
				<tr>
					<th>직종</th>
					<td><input type="button" value="직종" onclick="openjoblist()"><input
						type="text" value="직종" name="job" id="job" readonly></td>
				</tr>
				<tr>
					<th>근무형태</th>
			...
			<table>
				...
				<tr>
					...
					<td><div id="checkworkday" style="display: none;">
						...
						<input type="text" id="workday" name="workday"></td>
				</tr>
				<tr>
					<th>근무시간</th>
				...
				<tr>
					...
					<td><div id="checkworktime" style="display: none;">
							...
							</select> : <select name="workstarttime2"><option value="00">0</option>
								<option value="30">30</option></select> ~ 근무종료시간 <select
								name="workendtime1">
								<c:forEach var="i" begin="0" end="48" step="1">
									<option value="${i}">${i}</option>
								</c:forEach>
							</select> : <select name="workendtime2"><option value="00">0</option>
				...
				<tr>
					...
					<td><input type="radio" value="시급" class="btn-check"
						id="pay_category" name="h_pay_category" autocomplete="off" checked><label
						class="btn btn-outline-primary" for="pay_category">시급</label> <input
						type="radio" value="월급" class="btn-check" id="pay_category1"
						name="h_pay_category" autocomplete="off"><label
						class="btn btn-outline-primary" for="pay_category1">월급</label> <input
						type="radio" value="협의" class="btn-check" id="pay_category2"
						name="pay_category" autocomplete="off"><label
						class="btn btn-outline-primary" for="pay_category2">협의</label><br>
					<div id="hourworktime" style="display: none;">
							<input type="text" name="pay" value="0">원
						</div>
						<div id="weekworktime" style="display: none;">
							<input type="text" name="pay" value="0">원 1주 근무시간<input
								type="number" name="worktime" value="0">
						</div></td>
				</tr>
			</table>
		</div>
		...
		<div>
			...
			<div>
				<table>
					<tr>
						<th>근무지주소</th>
						<td><input type="text" id="searchadd" readonly
							placeholder="주소 검색을 해주세요."> <input type="button"
							onclick="sample5_execDaumPostcode()" value="주소 검색"> <input
							type="hidden" name="x" id="x"> <input type="hidden"
							name="y" id="y"> <input type="hidden" id="sido"
							name="local1"> <input type="hidden" id="sigungu"
							name="local2"> <input type="hidden" id="query"
							name="local3"></td>
					</tr>
					<tr>
						<th>상세주소</th>
				...
				<div id="map"
					style="width: 100%; height: 400px; margin-top: 10px; display: none"></div>
			</div>
			<script
